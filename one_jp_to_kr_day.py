...
s3_key = 'one_trip/'+'jp_'+dag_date+'.csv' # 현재 날짜에서 5일 뒤로 수정
...
# Airflow DAG에 태스크 추가
with DAG('api_jp_to_kr_day', default_args=default_args, description='Fetch flight offers from Amadeus API and save to S3', schedule_interval=timedelta(days=1),catchup = False) as dag:
